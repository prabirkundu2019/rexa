...
export class AddAddressPage implements OnInit {
	...
	Length:any;
	CustomerLoginId: "";
	model = {add1:'',add2:'',zip:'',ano:'',city:'',state:'',country:'',addtype:6,other:'',isdefault:false}
  ...
  ngOnInit() {
  	if(this.prevadd){
		this.model = {add1:this.prevadd.AddressValue.split(',')[0],add2:this.prevadd.AddressValue.split(',')[1],zip:this.prevadd.PostCode,ano:this.prevadd.MobileNo,city:this.prevadd.CityId,state:this.prevadd.StateId,country:this.prevadd.CountryId,addtype:this.prevadd.AddressType,other:this.prevadd.DescriptionForOther,isdefault:this.prevadd.IsDefault?true:false};
